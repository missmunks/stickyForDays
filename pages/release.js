...
<br /><b>Lost and found policy:</b> If it is shiny and sticky, it is probably loved and will be reunited if at all possible; if it is a sock that has found it’s way into the depths of chaos, it has been chosen.
<br /><b>Food Zone:</b> Self‑serve caramel apple bar/buffet is a choose‑your‑own adventure. Nuts may exist, dairy may lurk, candy may pop, dyes may leave you pooping blue for a week. Read labels, ask questions, and when in doubt, choose a safe option. See the “I have an allergy!” section on the main page for guest‑shared notes. We’ll do our best to keep any known allergies protected. When in doubt, try a rice cake and a hug.
<br />Trees are scenic, not trampolines; fences are fences, not balance beams; the zip line brake calculations are based on weight and pitch - and we did the math, sooooo…... Capes are optional but do not confer the power of flight.
